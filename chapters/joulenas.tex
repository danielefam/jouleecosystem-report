...
Each run outputs a metrics CSV (tracking accuracy, active channels, and energy) and a final mask checkpoint, which is ready for physical deployment and hardware validation (Chapter~\ref{chap:bridge}).
