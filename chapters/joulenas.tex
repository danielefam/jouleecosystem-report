...
\end{enumerate}
These experiments confirm that when GPU launch overheads are amortized by batching, JouleNAS effectively prunes channels in direct proportion to arithmetic workload, confirming that the hardware-aware search generalises across both execution batch sizes and compute regimes.
