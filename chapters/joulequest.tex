...
\begin{itemize}
    ...
    \item \texttt{pruned\_resnet\_}\allowbreak\texttt{measurement.md} --- documents the spec-driven
    workflow for pruned ResNet-18 composition measurements, detailing how a
    single JouleNAS pruning log drives dynamic model construction, component
    layer scheduling, deterministic architecture hashing, and physical validation.
\end{itemize}
